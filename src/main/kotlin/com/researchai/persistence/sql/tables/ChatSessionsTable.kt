...
object ChatSessionsTable : Table("chat_sessions") {
    ...
    val messages = jsonb<List<Map<String, Any>>>("messages", json).default(emptyList())
    ...
    val archivedMessages = jsonb<List<Map<String, Any>>>("archived_messages", json).default(emptyList())
    val compressionConfig = jsonb<Map<String, Any>>("compression_config", json).default(emptyMap())
